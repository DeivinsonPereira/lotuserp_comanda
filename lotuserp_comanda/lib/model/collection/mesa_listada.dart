...
class mesa_listada {
  ...
  factory mesa_listada.fromMap(Map<String, dynamic> map) {
    return mesa_listada(
      ...
      id_partner_cliente: map['id_partner_cliente'] != null ? map['id_partner_cliente'] as int : 0,
      ...
      total_consumo: map['total_consumo'] != null ? map['total_consumo'] is int? (map['total_consumo'] as int).toDouble() : map['total_consumo'] as double : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory mesa_listada.fromJson(String source) => mesa_listada.fromMap(json.decode(source) as Map<String, dynamic>);
}
