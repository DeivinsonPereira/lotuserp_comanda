...
class MesaExtrato {
  ...
  factory MesaExtrato.fromMap(Map<String, dynamic> map) {
    return MesaExtrato(
      ...
      produto_complemento: map['produto_complemento'] != null
          ? map['produto_complemento'] as String
          : null,
      vlr_vendido: map['vlr_vendido'] != null
          ? map['vlr_vendido'] is int
      ...
      qtde: map['qtde'] != null
          ? map['qtde'] is int
              ...
              : map['qtde'] as double
          : null,
      vlr_liquido: map['vlr_liquido'] != null
          ? map['vlr_liquido'] is int
              ? (map['vlr_liquido'] as int).toDouble()
              : map['vlr_liquido'] as double
          : null,
      id_usuario: map['id_usuario'] != null ? map['id_usuario'] as int : null,
      usuario_nome:
          map['usuario_nome'] != null ? map['usuario_nome'] as String : null,
      item_descricao: map['item_descricao'] != null
          ? map['item_descricao'] as String
          : null,
      item_complemento: map['item_complemento'] != null
          ? map['item_complemento'] as String
          : null,
    );
  }
  ...
  factory MesaExtrato.fromJson(String source) =>
      MesaExtrato.fromMap(json.decode(source) as Map<String, dynamic>);
}
